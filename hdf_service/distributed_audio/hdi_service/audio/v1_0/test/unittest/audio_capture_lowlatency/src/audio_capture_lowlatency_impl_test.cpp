...
#include "audio_capture_lowlatency_impl_test.h"
...
namespace Audio {
namespace V1_0 {
void AudioCaptureLowlatencyImplTest::SetUpTestCase(void) {}

void AudioCaptureLowlatencyImplTest::TearDownTestCase(void) {}

void AudioCaptureLowlatencyImplTest::SetUp(void)
{
    std::string adpName;
    AudioDeviceDescriptor desc;
    AudioSampleAttributes attrs;
    sptr<IDAudioCallback> callback;
    audioCapturelatencyImpl_ = std::make_shared<AudioCaptureLowLatencyImpl>(adpName, desc, attrs, callback);
}

void AudioCaptureLowlatencyImplTest::TearDown(void)
{
 ...
 */
HWTEST_F(AudioCaptureLowlatencyImplTest, InitAshmem_001, TestSize.Level1)
{
 ...
 * @tc.require: AR000HP6J4
 */
HWTEST_F(AudioCaptureLowlatencyImplTest, InitAshmem_002, TestSize.Level1)
{
...
HWTEST_F(AudioCaptureLowlatencyImplTest, Start_001, TestSize.Level1)
{
    ...
    EXPECT_EQ(HDF_SUCCESS, audioCapturelatencyImpl_->GetMmapPosition(frames, time));
 ...
 * @tc.require: AR000HP6J4
 */
HWTEST_F(AudioCaptureLowlatencyImplTest, Start_002, TestSize.Level1)
{
    int32_t range = 1;
    int32_t fd = 1;
 ...
 * @tc.require: AR000HP6J4
 */
HWTEST_F(AudioCaptureLowlatencyImplTest, ReqMmapBuffer_001, TestSize.Level1)
{
    int32_t reqSize = 30;
 ...
 * @tc.require: AR000HP6J4
 */
HWTEST_F(AudioCaptureLowlatencyImplTest, ReqMmapBuffer_002, TestSize.Level1)
{
    int32_t reqSize = 30;
    AudioMmapBufferDescriptor desc;
 ...
 * @tc.require: AR000HP6J4
 */
HWTEST_F(AudioCaptureLowlatencyImplTest, SetMute_001, TestSize.Level1)
{
    bool mute = true;
    float volume = 0.0;
    float min = 0.0;
