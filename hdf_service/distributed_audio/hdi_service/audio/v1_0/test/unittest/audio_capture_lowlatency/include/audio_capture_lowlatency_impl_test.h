...
#ifndef OHOS_AUDIO_CAPTURE_LOWLATENCY_IMPL_TEST_H
#define OHOS_AUDIO_CAPTURE_LOWLATENCY_IMPL_TEST_H
...
class AudioCaptureLowlatencyImplTest : public testing::Test {
public:
    ...
    std::shared_ptr<AudioCaptureLowLatencyImpl> audioCapturelatencyImpl_ = nullptr;
};
} // V1_0
} // Audio
} // Distributedaudio
...
#endif // OHOS_AUDIO_CAPTURE_LOWLATENCY_IMPL_TEST_H
