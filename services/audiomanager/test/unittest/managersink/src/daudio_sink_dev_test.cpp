 ...
 */
HWTEST_F(DAudioSinkDevTest, IsSpeakerEvent_001, TestSize.Level1)
{
    AudioEvent event(AudioEventType::OPEN_SPEAKER, "");
    EXPECT_EQ(true, sinkDev_->IsSpeakerEvent(event));
}

/**
 * @tc.name: IsSpeakerEvent_002
 * @tc.desc: Verify the IsSpeakerEvent function.
 * @tc.type: FUNC
 * @tc.require: AR000H0E5F
 */
HWTEST_F(DAudioSinkDevTest, IsSpeakerEvent_002, TestSize.Level1)
{
    AudioEvent event(AudioEventType::OPEN_MIC, "");
    EXPECT_EQ(false, sinkDev_->IsSpeakerEvent(event));
}
 ...
 * @tc.require: AR000H0E5F
 */
HWTEST_F(DAudioSinkDevTest, IsMicEvent_001, TestSize.Level1)
{
    AudioEvent event(AudioEventType::OPEN_MIC, "");
    EXPECT_EQ(true, sinkDev_->IsMicEvent(event));
}

/**
 * @tc.name: IsMicEvent_002
 * @tc.desc: Verify the IsMicEvent function.
 * @tc.type: FUNC
 * @tc.require: AR000H0E5F
 */
HWTEST_F(DAudioSinkDevTest, IsMicEvent_002, TestSize.Level1)
{
    AudioEvent event(AudioEventType::OPEN_SPEAKER, "");
    EXPECT_EQ(false, sinkDev_->IsMicEvent(event));
}

/**
 * @tc.name: IsVolumeEvent_001
 * @tc.desc: Verify the IsVolumeEvent function.
 * @tc.type: FUNC
 * @tc.require: AR000H0E5F
 */
HWTEST_F(DAudioSinkDevTest, IsVolumeEvent_001, TestSize.Level1)
{
    AudioEvent event(AudioEventType::VOLUME_SET, "");
    EXPECT_EQ(true, sinkDev_->IsVolumeEvent(event));
}

/**
 * @tc.name: IsVolumeEvent_002
 * @tc.desc: Verify the IsVolumeEvent function.
 * @tc.type: FUNC
 * @tc.require: AR000H0E5F
 */
HWTEST_F(DAudioSinkDevTest, IsVolumeEvent_002, TestSize.Level1)
{
    AudioEvent event(AudioEventType::OPEN_MIC, "");
    EXPECT_EQ(false, sinkDev_->IsVolumeEvent(event));
}
