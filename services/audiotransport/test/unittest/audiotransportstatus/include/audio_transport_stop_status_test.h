...
#ifndef AUDIO_TRANSPORT_STOP_STATUS_TEST_H
#define AUDIO_TRANSPORT_STOP_STATUS_TEST_H
...
class AudioTransportStopStatusTest : public testing::Test {
public:
...
#endif // AUDIO_TRANSPORT_STOP_STATUS_TEST_H
