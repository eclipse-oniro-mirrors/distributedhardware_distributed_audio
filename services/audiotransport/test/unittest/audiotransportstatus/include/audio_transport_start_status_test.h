...
#ifndef AUDIO_TRANSPORT_START_STATUS_TEST_H
#define AUDIO_TRANSPORT_START_STATUS_TEST_H
...
class AudioTransportStartStatusTest : public testing::Test {
public:
    ...
    std::shared_ptr<AudioTransportStatus> audioStatus_ = nullptr;
};
} // namespace DistributedHardware
} // namespace OHOS
#endif // AUDIO_TRANSPORT_START_STATUS_TEST_H
