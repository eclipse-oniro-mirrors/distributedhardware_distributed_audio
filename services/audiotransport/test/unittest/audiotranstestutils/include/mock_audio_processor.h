...
#ifndef OHOS_AUDIO_PROCESSOR_H
#define OHOS_AUDIO_PROCESSOR_H

#include "iaudio_processor.h"

namespace OHOS {
namespace DistributedHardware {
class MockIAudioProcessor : public IAudioProcessor {
public:
    explicit MockIAudioProcessor() {}
    ~MockIAudioProcessor() {}
