...
private:
    ...
    bool IsInEncodeRange(const AudioCommonParam &codecParam);
...
private:
    ...
    static constexpr const char* ENCODE_THREAD = "encodeThread";
    ...
    std::shared_ptr<Media::AVCodecCallback> encoderCallback_ = nullptr;
