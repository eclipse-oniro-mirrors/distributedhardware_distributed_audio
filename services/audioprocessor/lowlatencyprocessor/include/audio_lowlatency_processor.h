...
#ifndef OHOS_IAUDIO_LOWLATENCY_PROCESSOR_H
#define OHOS_IAUDIO_LOWLATENCY_PROCESSOR_H
...
class AudioLowlatencyProcessor : public IAudioProcessor,
    public std::enable_shared_from_this<AudioLowlatencyProcessor> {
public:
    AudioLowlatencyProcessor() = default;
    ~AudioLowlatencyProcessor() = default;
