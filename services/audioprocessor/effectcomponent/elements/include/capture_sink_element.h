...
#ifndef CAPTURE_SINK_ELEMENT_H
#define CAPTURE_SINK_ELEMENT_H
...
class CaptureSinkElement : public DownStreamElement {
public:
    CaptureSinkElement() = default;
    ~CaptureSinkElement() = defualt;
...
private:
    std::string elemType_ = SINK_MIC;
};
} // OHOS
} // DistributedHardware
#endif // CAPTURE_SINK_ELEMENT_H
