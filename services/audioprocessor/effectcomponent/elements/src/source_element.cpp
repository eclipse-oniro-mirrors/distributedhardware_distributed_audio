...
#undef DH_LOG_TAG
#define DH_LOG_TAG "SourceElement"

namespace OHOS {
namespace DistributedHardware {
int32_t SourceElement::Init(std::string config)
{
...
int32_t SourceElement::ShutDown()
{
...
std::string SourceElement::GetType()
{
    return elemType_;
}

int32_t SourceElement::PushData(std::shared_ptr<AudioData> &inData, std::shared_ptr<AudioData> &outData)
{
...
int32_t SourceElement::DoProcessData(std::shared_ptr<AudioData> &inData, std::shared_ptr<AudioData> &outData)
{
