...
#ifndef OHOS_IAUDIO_DECODER_PROCESSOR_H
#define OHOS_IAUDIO_DECODER_PROCESSOR_H
...
class AudioDecoderProcessor : public IAudioProcessor, public IAudioCodecCallback,
...
#endif // OHOS_IAUDIO_DECODER_PROCESSOR_H
